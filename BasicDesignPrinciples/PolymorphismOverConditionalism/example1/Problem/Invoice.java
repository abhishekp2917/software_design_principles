...
/*
    ...
    calculate invoice conditionally (by using if-else conditional statements) generate 
    invoice but this way it violates Open Closed principle cause if we want to extend 
    the functionality of calculating invoice object like adding new customer type then 
    we would end up modifying existing code
*/
public class Invoice {
    ...
    public double calculateTotalPrice() {
        ...
        // calculate invoice using below logic if customer is silver card holder
        ...
        // calculate invoice using below logic if customer is normal customer
        else {
